...
@Component({
  selector: 'app-formly-form-example',
  templateUrl: './formly-form-example.component.html',
  styleUrls: ['./formly-form-example.component.scss']
})
export class FormlyFormExampleComponent {
  form = new FormGroup({});
  model: any = {};
